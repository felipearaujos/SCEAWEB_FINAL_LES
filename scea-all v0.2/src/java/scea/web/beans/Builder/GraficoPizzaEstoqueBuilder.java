 ...
 * @author Main User
 */
public class GraficoPizzaEstoqueBuilder {
    
    private PieChartModel graficoPizza;

    public GraficoPizzaEstoqueBuilder  initModelo(List<EntidadeDominio> entidades) {
  ...
  public GraficoPizzaEstoqueBuilder informacoesGrafico()
  {
        graficoPizza.setTitle("Análise de Armazenamento do Estoque Físico");
