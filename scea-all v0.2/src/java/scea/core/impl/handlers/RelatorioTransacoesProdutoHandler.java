 ...
 * @author Main User
 */
public class RelatorioTransacoesProdutoHandler extends Handler{
    ...
    public List<EntidadeDominio> processarRequisicao(EntidadeDominio entidade) {
        ...
        RelatoriosDAO rlDAO = new RelatoriosDAO();
            if(relatorio.getNome().toUpperCase().equals("RELATORIOTRANSACOESPRODUTO")){
                return rlDAO.relatorioTransacoesProduto(entidade);
            }
            else
            {
