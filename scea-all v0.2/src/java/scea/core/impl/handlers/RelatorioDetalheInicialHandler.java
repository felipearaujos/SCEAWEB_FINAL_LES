 ...
 * @author Main User
 */
public class RelatorioDetalheInicialHandler extends Handler{
    ...
    public List<EntidadeDominio> processarRequisicao(EntidadeDominio entidade) {
        ...
        RelatoriosDAO rlDAO = new RelatoriosDAO();
            if(relatorio.getNome().toUpperCase().equals("RELATORIODETALHEINICIAL")){
                return rlDAO.relatorioTransacoes(entidade);
            }
            else
            {
